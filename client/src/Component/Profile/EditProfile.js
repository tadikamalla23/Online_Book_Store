  ...
  handleChange = (event) => {
    ...
    switch (id) {
      ...
      case "lastName":
        ...
        break;
      case "userName":
        errors.userName = /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(
          value,
        )
          ? ""
      ...
      case "address":
        errors.address =
          value.length < 8 ? "address must be at least 8 characters long!" : "";

        break;
      case "pincode":
        errors.pincode =
          value.length < 6 ? "Pincode must be atleast 6 Numbers long!" : "";

        break;
      case "phnNo":
        errors.phnNo =
          value.length < 10 ? "Phone Number must be 10 Numbers long!" : "";
              ...
              <form onSubmit={this.handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="form-control"
                    onChange={this.handleChange}
                    placeholder="ex: abcdef@ghijk.xyz"
                    required
                    readOnly
                  />
                  <div className="float-right error">
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="form-group">
                      <label htmlFor="address" className="float-left">
                        Address:
                      </label>
                      <input
                        id="address"
                  ...
                  <div className="col-6">
                    <div className="form-group">
                      <label htmlFor="pincode" className="float-left">
                        Pincode:
                      </label>
                      <input
                        id="pincode"
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="form-group">
                      <label htmlFor="state" className="float-left">
                        State:
                      </label>
                      <select
                        id="state"
                ...
                <div className="form-group">
                  <label htmlFor="phnNo" className="float-left">
                    Phone Number:
                  </label>
                  <input
                    id="phnNo"
                  ...
                  <div className="float-right error">
                    {errors.phnNo.length > 0 && (
                      <span className="error">{errors.phnNo}</span>
                    )}
                  </div>
                </div>
                <input
